...
public class FillBlankFormWithRepeatGroupTest extends BaseRegressionTest {
    ...
    public void nestedGroupsWithFieldListAppearance_ShouldBeAbleToFillTheForm() {
        ...
        new MainMenuPage(main).startBlankForm("form3")
                .swipeToNextQuestion()
                .clickSaveAndExit();

        new MainMenuPage(main).startBlankForm("form4")
                .inputText("T1")
                .closeSoftKeyboard()
                .swipeToNextQuestion()
                .inputText("T2")
        ...
        new MainMenuPage(main).startBlankForm("form5")
                .inputText("T1")
                .closeSoftKeyboard()
                .swipeToNextQuestion()
                .inputText("T2")
        ...
        new MainMenuPage(main).startBlankForm("form6")
                .inputText("T1")
                .closeSoftKeyboard()
                .swipeToNextQuestion()
                .inputText("T2")
        ...
        new MainMenuPage(main).startBlankForm("form7")
                .swipeToNextQuestion()
                .clickSaveAndExit();

        new MainMenuPage(main).startBlankForm("form8")
                .swipeToNextQuestion()
                .clickSaveAndExit();

        new MainMenuPage(main).startBlankForm("form9")
                .swipeToNextQuestion()
                .clickSaveAndExit();
    }
